...
<body
				...
				<section class="" id="flow">
					<div class="flow_content firsttext">
						<div class="flow_inside image left">
							<img
								src="http://swativerma.com/wp-content/uploads/2017/05/Contact-us-form_2.jpg">
						</div>
						<div class="flow_inside text right">
							<h2>Contact Us</h2>
							<p>Please complete the form below and someone from our team
								will get in touch with you very soon. Thanks!</p>
							<noscript class="ninja-forms-noscript-message">
								Notice: JavaScript is required for this content.</noscript>
							<div id="nf-form-1-cont" class="nf-form-cont" aria-live="polite"
											...
											<form:form action="${sendMessage}" method="post"
												...
												<div class="nf-form-content ">
													<div id="nf-field-1-container"
														class="nf-field-container textbox-container  label-hidden ">
														<div class="nf-before-field"></div>
														<div class="nf-field">
															<div id="nf-field-1-wrap"
																class="field-wrap textbox-wrap nf-fail nf-error"
																data-field-id="1">
													...
													<div id="nf-field-2-container"
														...
														<div class="nf-field">
															<div id="nf-field-2-wrap" class="field-wrap email-wrap"
																data-field-id="2">
													...
													<div id="nf-field-3-container"
														...
														<div class="nf-field">
															<div id="nf-field-3-wrap"
																class="field-wrap textarea-wrap" data-field-id="3">

																<div class="nf-field-element">
																	<form:textarea path="message" id="message"
																		placeholder="Message" cols="30" rows="7"
																		class="form-control" />
																</div>
													...
													<div id="nf-field-4-container"
														...
														<div class="nf-field">
															<div id="nf-field-4-wrap"
																...
																<div class="nf-field-element">
																	<input id="nf-field-4"
																		class="ninja-forms-field nf-element " type="submit"
																		value="Send">
																</div>
															</div>
														</div>
	...
	<link rel='stylesheet' id='dashicons-css'
		href='http://swativerma.com/wp-includes/css/dashicons.min.css?ver=4.9.10'
		type='text/css' media='all' />
	<link rel='stylesheet' id='nf-display-css'
		href='http://swativerma.com/wp-content/plugins/ninja-forms/assets/css/display-structure.css?ver=4.9.10'
		type='text/css' media='all' />
	<script type='text/javascript'
	...
	<script type='text/javascript'
		src='http://swativerma.com/wp-includes/js/underscore.min.js?ver=1.8.3'></script>
	<script type='text/javascript'
		src='http://swativerma.com/wp-includes/js/backbone.min.js?ver=1.2.3'></script>
	<script type='text/javascript'
		src='http://swativerma.com/wp-content/plugins/ninja-forms/assets/js/min/front-end-deps.js?ver=3.2.11'></script>
...
<!-- Cached page generated by WP-Super-Cache on 2019-08-11 16:25:53 -->
