		...
		<div id="">
			...
			<header>
				...
				<div id="pagepost" class="hfeed">
					<h2 style="font-family: cursive;">Write Blog</h2>
					<!--<p class="thedate"><strong>2018-05-23</strong></p>-->
					<div class="entry-content" style="margin-left: -50px;">
						<div class="container">
							<form:form method="POST"
								action="postBlog?${_csrf.parameterName}=${_csrf.token}"
								enctype="multipart/form-data" modelAttribute="makeupblog">
								<input type="hidden" name="${_csrf.parameterName}"
									value="${_csrf.token}" />
								<form:input type="hidden" path="id" id="id" />
								<div class="row">
									<div class="col-25">
										<label for="fname" style="font-family: cursive;">Title</label>
									</div>
									<div class="col-75" style="width: 150%;">
										<form:input type="text" path="title" id="title"
											placeholder="Enter Title here" style="width: 500px;background-color: white;"/>
									</div>
								</div>

								<div class="row">
									<div class="col-25">
										<label for="subject" style="font-family: cursive;">Content</label>
									</div>
									<div class="col-75">
										<form:textarea path="articleContent" id="articleContent"
											placeholder="Article Content" cols="30" rows="7"
											class="form-control" style="margin: 0px; width: 500px; height: 233px;background-color: white;"/>
									</div>
								</div>
								<div class="row">
									<div class="col-25">
								...
								<c:choose>
						<c:when test="${edit}">
							<input type="submit" value="Update" style="background-color: white;"/>
						</c:when>
						<c:otherwise>
