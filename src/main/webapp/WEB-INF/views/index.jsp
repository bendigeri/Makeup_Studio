...
<nav class="navbar navbar-expand-md navbar-dark" id="ftco-navbar" style="background-color: black">
	...
	<section class="carousel slide cid-ruv1vrquBa" data-interval="false"
		id="slider2-0" style="background-color: black;">


		<div class="container content-slider">
			<div class="content-slider-wrap" style="width: 75%;">
				<div>
					<div class="mbr-slider slide carousel" data-pause="false"
						data-keyboard="false" data-ride="carousel" data-interval="5000">
						<ol class="carousel-indicators">
							<li data-app-prevent-settings="" data-target="#slider2-0"
								data-slide-to="0"></li>
							<li data-app-prevent-settings="" data-target="#slider2-0"
								class=" active" data-slide-to="1"></li>
							<li data-app-prevent-settings="" data-target="#slider2-0"
								data-slide-to="2"></li>
						</ol>
						...
						<a data-app-prevent-settings=""
							...
							data-slide="prev" href="#slider2-0"><span aria-hidden="true"
							...
							data-slide="next" href="#slider2-0"><span aria-hidden="true"
	...
	<!-- <section class="carousel slide cid-ruv1xdLeji" data-interval="false"
		id="slider2-2">
				...
				<div>
					<div class="mbr-slider slide carousel" data-pause="false"
						...
						<div class="carousel-inner" role="listbox">
							<div class="carousel-item slider-fullscreen-image"
								data-bg-video-slide="false"
								style="background-image: url(./static/assets/images/7-1200x1600.jpg);">
								<div class="container container-slide">
									<div class="image_wrapper">
										<img src="./static/assets/images/7-1200x1600.jpg">
										<div class="carousel-caption justify-content-center">
							...
							<div class="carousel-item slider-fullscreen-image"
								data-bg-video-slide="false"
								style="background-image: url(./static/assets/images/8-1200x1600.jpg);">
								<div class="container container-slide">
									<div class="image_wrapper">
										<img src="./static/assets/images/8-1200x1600.jpg">
										<div class="carousel-caption justify-content-center">
											<div class="col-10 align-center"></div>
										</div>
									</div>
							...
							<div class="carousel-item slider-fullscreen-image active"
								data-bg-video-slide="false"
								style="background-image: url(./static/assets/images/9-1200x1600.jpg);">
								<div class="container container-slide">
									<div class="image_wrapper">
										<img src="./static/assets/images/9-1200x1600.jpg">
										<div class="carousel-caption justify-content-center">
											<div class="col-10 align-center"></div>
										</div>
									</div>
						...
						<a data-app-prevent-settings=""
							class="carousel-control carousel-control-prev" role="button"
							data-slide="prev" href="#slider2-2"><span aria-hidden="true"
							class="mbri-left mbr-iconfont"></span><span class="sr-only">Previous</span></a><a
							data-app-prevent-settings=""
							class="carousel-control carousel-control-next" role="button"
							data-slide="next" href="#slider2-2"><span aria-hidden="true"
							class="mbri-right mbr-iconfont"></span><span class="sr-only">Next</span></a>
					</div>
				</div>
			</div>
